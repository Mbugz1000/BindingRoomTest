...
//------------------------------------------ Not Necessary ---------------------------------------------------------------------
    ...
    public static void setInverseBindingListener(Spinner spinner, InverseBindingListener inverseBindingListener){
        SpinnerExtentions.setSpinnerInverseBindingListener(spinner, inverseBindingListener);
    }
